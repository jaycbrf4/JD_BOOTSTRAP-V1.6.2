		...
		<article id="post-not-found" class="clearfix">
			...
			<section class="post_content">
				...
				<div class="row">
					...
					<p><?php _e("Please use the seach box below if you are looking for something specific you can use the search box below or the site map in the footer with links to every page on this site. ","JD_BOOTSTRAP"); ?></p>
